 ...
 * 
 * <p>Classe Java pour ExchangeId complex type.
 * 
 ...
 *       &lt;attribute name="exchangeIdScheme" type="{http://www.w3.org/2001/XMLSchema}anyURI" default="http://www.fpml.org/spec/2002/exchange-id-MIC-1-0" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class ExchangeId {
    ...
    /**
     * Obtient la valeur de la propriété exchangeIdScheme.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    public String getExchangeIdScheme() {
        if (exchangeIdScheme == null) {
            return "http://www.fpml.org/spec/2002/exchange-id-MIC-1-0";
        } else {
    ...
    /**
     * Définit la valeur de la propriété exchangeIdScheme.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
