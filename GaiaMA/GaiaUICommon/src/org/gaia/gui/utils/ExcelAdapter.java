...
public class ExcelAdapter implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().compareTo("Copy") == 0) {
            ...
            // cells
            int numcols = jTable1.getColumnCount();//.getSelectedColumnCount();
            ...
            while (cols.hasMoreElements()) {
                ...
                sbf.append(c.getHeaderValue().toString());
                sbf.append("\t");
            }
            sbf.append("\n");
        ...
        if (e.getActionCommand().compareTo("Paste") == 0) {
            ...
            try {
                ...
                logger.info("String is:" + trstring);
                StringTokenizer st1 = new StringTokenizer(trstring, "\n");
                for (int i = 0; st1.hasMoreTokens(); i++) {
                    if (i > jTable1.getRowCount() - 1) {
                        ((DefaultTableModel) jTable1.getModel()).addRow(new Vector(jTable1.getColumnCount()));
