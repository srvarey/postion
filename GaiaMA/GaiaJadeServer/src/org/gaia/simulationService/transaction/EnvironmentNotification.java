...
/**
 * This class is used as generalized notification to agents, that are using the
...
public class EnvironmentNotification implements Serializable {
     ...
     * @param comingFromManager true, if this message comes from the manager of
     * a simulation
    ...
    /**
     * Returns the processing instruction for the further handling of the
     * notification.
     *
    ...
    /**
     * Sets the notification to be moved to the last position of the
     * notification queue. In case that this is already the last notification,
     * the notification will be block for a certain amount of time in
     * milliseconds.
     */
    ...
    /**
     * The Class ProcessingInstruction can be used in order to set the further
     * handling with the {@link EnvironmentNotification}.
     *
     */
