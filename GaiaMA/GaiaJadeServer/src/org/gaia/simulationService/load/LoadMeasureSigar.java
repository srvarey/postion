 ...
 * Therefore the Hyperic-SIGAR API is used, which can be found <a
 * href="http://www.hyperic.com/support/docs/sigar/" target="_blank">here</a>.
 *
 */
public class LoadMeasureSigar extends SigarCommandBase implements Cloneable {
    private static final Logger logger = Logger.getLogger(LoadMeasureSigar.class);
     ...
     */
    private long totalMemorySwap; 		
    /**
     * A swap memory information.
     */
    private long freeMemorySwap;		
    /**
     * A swap memory information.
     */
    private long useMemorySwap;			
    /**
