 ...
 */
public class PricerZero implements IPricer, INPVPricer {
    ...
    @Override
     public Map<MeasuresAccessor.Measure,MeasureValue[]> calculate(IPriceable priced, Map observables, Date dateValo, boolean withDetails) {
        ...
        MeasureValue meas = new MeasureValue(MeasuresAccessor.Measure.NPV_unit, BigDecimal.ZERO, priced.getProduct().getNotionalCurrency(), dateValo, priced.getId());
        listMeasure.put(MeasuresAccessor.Measure.NPV_unit, new MeasureValue[]{meas});
