...
/**
 * <p>Classe Java pour OriginatingEvent complex type.
 * 
 ...
 *       &lt;attribute name="originatingEventScheme" type="{http://www.w3.org/2001/XMLSchema}anyURI" default="http://www.fpml.org/coding-scheme/originating-event" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class OriginatingEvent {
    ...
    /**
     * Obtient la valeur de la propriété originatingEventScheme.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété originatingEventScheme.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
