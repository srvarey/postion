 ...
 * 
 * <p>Classe Java pour BrokerConfirmationType complex type.
 * 
 ...
 *       &lt;attribute name="brokerConfirmationTypeScheme" type="{http://www.w3.org/2001/XMLSchema}anyURI" default="http://www.fpml.org/coding-scheme/broker-confirmation-type" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class BrokerConfirmationType {
    ...
    /**
     * Obtient la valeur de la propriété brokerConfirmationTypeScheme.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété brokerConfirmationTypeScheme.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
