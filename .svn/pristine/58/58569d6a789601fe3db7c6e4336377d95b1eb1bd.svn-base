...
public class ProductReferenceCustomColumnTest extends AbstractTest{

    /**
     * Test of calculate method, of class ProductReferenceCustomColumn.
     */
    @Test
    public void testCalculate() {
        ...
        assertNotNull("failed to calculate product reference custom column", result);
    }
