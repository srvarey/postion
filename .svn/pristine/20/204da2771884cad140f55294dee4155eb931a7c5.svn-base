...
public class TradeTimeCustomColumnTest extends AbstractTest{

    /**
     * Test of calculate method, of class TradeTimeCustomColumn.
     */
    @Test
    public void testCalculate() {
        ...
        assertNotNull("failed to calculate trade time custom column", result);
    }
