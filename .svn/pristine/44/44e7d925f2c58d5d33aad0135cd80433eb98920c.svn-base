 ...
 * 
 * <p>Classe Java pour OrganizationCharacteristic complex type.
 * 
 ...
 *       &lt;attribute name="organizationCharacteristicScheme" type="{http://www.w3.org/2001/XMLSchema}anyURI" default="http://www.fpml.org/coding-scheme/organization-characteristic" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class OrganizationCharacteristic {
    ...
    /**
     * Obtient la valeur de la propriété organizationCharacteristicScheme.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété organizationCharacteristicScheme.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
