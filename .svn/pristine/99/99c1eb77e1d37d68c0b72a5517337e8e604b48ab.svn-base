 ...
 * 
 * <p>Classe Java pour ServiceProcessingStep complex type.
 * 
 ...
 *       &lt;attribute name="serviceProcessingStep" type="{http://www.w3.org/2001/XMLSchema}anyURI" default="http://www.fpml.org/coding-scheme/service-processing-step" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class ServiceProcessingStep {
    ...
    /**
     * Obtient la valeur de la propriété serviceProcessingStep.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété serviceProcessingStep.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
