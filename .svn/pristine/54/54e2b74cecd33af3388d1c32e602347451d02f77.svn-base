 ...
 * 
 * <p>Classe Java pour EmbeddedOptionType complex type.
 * 
 ...
 *       &lt;attribute name="embeddedOptionTypeScheme" type="{http://www.w3.org/2001/XMLSchema}anyURI" default="http://www.fpml.org/coding-scheme/embedded-option-type" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class EmbeddedOptionType {
    ...
    /**
     * Obtient la valeur de la propriété embeddedOptionTypeScheme.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété embeddedOptionTypeScheme.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
