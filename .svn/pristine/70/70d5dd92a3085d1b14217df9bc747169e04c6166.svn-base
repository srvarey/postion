 ...
 * 
 * <p>Classe Java pour ServiceAdvisoryCategory complex type.
 * 
 ...
 *       &lt;attribute name="serviceAdvisoryCategoryScheme" type="{http://www.w3.org/2001/XMLSchema}anyURI" default="http://www.fpml.org/coding-scheme/service-advisory-category" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class ServiceAdvisoryCategory {
    ...
    /**
     * Obtient la valeur de la propriété serviceAdvisoryCategoryScheme.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété serviceAdvisoryCategoryScheme.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
